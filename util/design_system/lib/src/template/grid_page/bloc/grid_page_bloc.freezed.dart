...
/// @nodoc
abstract class $GridPageEventCopyWith<$Res> {
  factory $GridPageEventCopyWith(
          GridPageEvent value, $Res Function(GridPageEvent) then) =
      _$GridPageEventCopyWithImpl<$Res>;
}

/// @nodoc
class _$GridPageEventCopyWithImpl<$Res>
    implements $GridPageEventCopyWith<$Res> {
  _$GridPageEventCopyWithImpl(this._value, this._then);

  final GridPageEvent _value;
  // ignore: unused_field
  final $Res Function(GridPageEvent) _then;
}
...
/// @nodoc
class __$$_LoadCopyWithImpl<$Res> extends _$GridPageEventCopyWithImpl<$Res>
...
abstract class _Load implements GridPageEvent {
  const factory _Load() = _$_Load;
}

/// @nodoc
mixin _$GridPageState<T> {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
...
/// @nodoc
abstract class $GridPageStateCopyWith<T, $Res> {
  factory $GridPageStateCopyWith(
          GridPageState<T> value, $Res Function(GridPageState<T>) then) =
      _$GridPageStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$GridPageStateCopyWithImpl<T, $Res>
    implements $GridPageStateCopyWith<T, $Res> {
  _$GridPageStateCopyWithImpl(this._value, this._then);

  final GridPageState<T> _value;
  // ignore: unused_field
  final $Res Function(GridPageState<T>) _then;
}
...
class _$_Initial<T> implements _Initial<T> {
  ...
  @override
  String toString() {
    return 'GridPageState<$T>.initial()';
  }
...
abstract class _Initial<T> implements GridPageState<T> {
...
class _$_Loading<T> implements _Loading<T> {
  ...
  @override
  String toString() {
    return 'GridPageState<$T>.loading()';
  }
...
abstract class _Loading<T> implements GridPageState<T> {
...
abstract class _Error<T> implements GridPageState<T> {
